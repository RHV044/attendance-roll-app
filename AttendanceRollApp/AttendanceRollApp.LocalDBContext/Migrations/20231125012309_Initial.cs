        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthMethodId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_AuthenticationMethod_AuthMethodId",
                        column: x => x.AuthMethodId,
                        principalTable: "AuthenticationMethod",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendances_Person_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_AuthMethodId",
                table: "Attendances",
                column: "AuthMethodId");
